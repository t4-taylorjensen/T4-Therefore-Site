...
const ICONS = [
  { name: 'IconArrowRight',      Icon: IconArrowRight,      usage: 'Hero CTA, nav next' },
  { name: 'IconArrowLeft',       Icon: IconArrowLeft,       usage: 'Nav prev' },
  ...
  { name: 'IconArrowDiagonal',   Icon: IconArrowDiagonal,   usage: 'Nav overlay active link, card CTA' },
];
