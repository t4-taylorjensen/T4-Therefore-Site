...
import Stats from '../../../components/patterns/_archived/stats/Stats';
import HeroStack from '../../../components/patterns/_archived/hero-stack/HeroStack';
import CaseStudy from '../../../components/patterns/_archived/case-study/CaseStudy';
import LogoCarousel from '../../../components/patterns/logo-carousel/LogoCarousel';
import WhyTherefore from '../../../components/patterns/_archived/why-therefore/WhyTherefore';
import TestimonialsCarousel from '../../../components/patterns/_archived/testimonials-carousel/TestimonialsCarousel';
import FeatureStack, { DEFAULT_CARDS as FEATURE_CARDS } from '../../../components/patterns/_archived/feature-stack/FeatureStack';
import FAQ from '../../../components/patterns/faq/FAQ';
import ContactCTA from '../../../components/patterns/_archived/contact-cta/ContactCTA';

import CMSPlatforms from '../../../components/patterns/cms-platforms/CMSPlatforms';
import MoreWork from '../../../components/patterns/_archived/more-work/MoreWork';
...
export default {
  title: 'Archived/Pages/Pillar Pages (v1)',
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
        component: 'Pre-V2 pillar page templates (CMS & Commerce, Digital Products, AI Capabilities). CMS Page V2 (Pages/Pillar Pages V2) supersedes the CMS template using fully-extracted Pattern components — Digital Products and AI Capabilities have not yet been rebuilt as V2-style pages, so this is kept here for reference and as the basis for that future work.',
      },
    },
  },
};
